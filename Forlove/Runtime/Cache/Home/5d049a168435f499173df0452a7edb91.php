...
<head>
	...
	<link rel="stylesheet" href="/biaobai/Public/Forlove/style.css">
	<script type="text/javascript" src="/biaobai/Public/Js/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="/biaobai/Public/Forlove/forlove.js"></script>
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
	<script>
	var URL = "/biaobai/index.php/home/index";
    var APP = "/biaobai/index.php";
    $(function(){
    	if(<?php echo W('info/info',array('noticflag'));?>==1){
    		$.get('/biaobai/index.php/home/index/nc', function(data) {
    		$(".wenc").html(data);
    		$(".ncmask").fadeIn(200);
    		});
    	}
...
<body>
	<div class="header">
		...
		<img src="/biaobai/Public/Forlove/logo.png" alt="告白墙" class="logo"><br>
...
<div class="main">
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="point">
		<div class="zzan">
			<a href="javascript:" class="jzan"><span id="<?php echo ($vo["id"]); ?>"><?php echo ($vo["zan"]); ?></span><img src="/biaobai/Public/Forlove/zan.png" alt="" class="zan"></a>	
		</div>
			<div class="ptop">
...
<div class="load">
	...
	<p>Prowered by <a href="https://skymz.cc" target="_blank" style="color: #fff;text-decoration: none;">Skymz.cc</a></p>
